...
const _sfc_main = {
  ...
  created() {
    if (!t) {
      const vueI18n = common_vendor.initVueI18n(common_vendor.messages);
      t = vueI18n.t;
    }
    this.platform();
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    w: !$data.isPhone && $data.popup
  }, !$data.isPhone && $data.popup ? common_vendor.e({
    x: !$data.isRange
    ...
    I: common_vendor.sr("pcSingle", "31e93180-4"),
    ...
    aj: common_vendor.sr("left", "31e93180-8"),
    ...
    ao: common_vendor.sr("right", "31e93180-9"),
    ...
    aB: common_vendor.sr("mobile", "31e93180-10"),
    aC: common_vendor.o($options.mobileChange),
    aD: common_vendor.o($options.close),
    aE: common_vendor.p({
      clearDate: false,
      date: $data.defSingleDate,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/zhangfangchao/projects/uni-app/node_modules/@dcloudio/uni-ui/lib/uni-datetime-picker/uni-datetime-picker.vue"]]);
