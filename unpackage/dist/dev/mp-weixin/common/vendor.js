...
const tabBar = {
  ...
  list: [
    {
      pagePath: "pages/home/list/index",
      iconPath: "static/images/react.png",
      selectedIconPath: "static/images/react_cur.png",
      text: "首页"
    },
    {
      pagePath: "pages/map/index",
      iconPath: "static/images/vscode.png",
      selectedIconPath: "static/images/vscode_cur.png",
      text: "点我"
    },
    {
      pagePath: "pages/user/index",
      iconPath: "static/images/vue.png",
      selectedIconPath: "static/images/vue_cur.png",
      text: "用户"
    }
  ]
};
...
const k = true, I = "mp-weixin", C = b([]), A = I, P = b('{\n    "address": [\n        "127.0.0.1",\n        "192.168.10.105"\n    ],\n    "debugPort": 9001,\n    "initialLaunchType": "local",\n    "servePort": 7002,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = b('[{"provider":"aliyun","spaceName":"cloud-uniapp","spaceId":"mp-96540286-31ad-4faa-8fc1-52e497c22e61","clientSecret":"fJUL/8OgMScDToXsKOCPWg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__E3EAA64";
} catch (e2) {
...
if (!Array) {
  const _easycom_qiun_loading2 = resolveComponent("qiun-loading");
  const _easycom_qiun_error2 = resolveComponent("qiun-error");
  (_easycom_qiun_loading2 + _easycom_qiun_error2)();
}
const _easycom_qiun_loading = () => "../uni_modules/qiun-data-charts/components/qiun-loading/qiun-loading.js";
const _easycom_qiun_error = () => "../uni_modules/qiun-data-charts/components/qiun-error/qiun-error.js";
if (!Math) {
